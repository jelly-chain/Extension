# install-all.ps1 — Install all Jelly-Research agent templates (Windows PowerShell)
...
Write-Host ""
Write-Host "  Installing all Jelly-Research agent templates..." -ForegroundColor Cyan
Write-Host ""
